...
7. 非标准 data 文本和插件源码文本只在高风险或用户明确要求时进入支线；用户未确认、审查 blocker 未关闭或仍有未归类候选时停止正文翻译。
...
13. 全量多轮后剩余量已经很小、适合人工收尾，或连续多轮同类失败不下降并已说明原因时，才导出手动填写译文表或质量修复表。

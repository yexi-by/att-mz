...
| 查看统一文本清单 | `.\att-mz.exe --agent-mode text-scope --game <游戏标题> --json` |
| 审计覆盖范围 | `.\att-mz.exe --agent-mode audit-coverage --game <游戏标题> --json` |
| 查看质量报告 | `.\att-mz.exe --agent-mode quality-report --game <游戏标题> --json` |
| 反查反馈原文 | `.\att-mz.exe --agent-mode verify-feedback-text --game <游戏标题> --input <反馈原文清单> --json` |
| 扫描插件源码候选 | `.\att-mz.exe --agent-mode scan-plugin-source-text --game <游戏标题> --output <候选文件> --json` |

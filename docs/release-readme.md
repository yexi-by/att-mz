...
A.T.T MZ 是面向 RPG Maker MV/MZ 日文游戏的 Agent 汉化工具。发行版已经带好可执行文件、默认配置、字体、提示词和 Agent Skill，不需要用户安装 Python、Rust 或 uv。
...
| 注册游戏 | `.\att-mz.exe --agent-mode add-game --path <游戏目录> --json` |
